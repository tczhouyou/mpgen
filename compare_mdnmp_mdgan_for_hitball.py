...
for expId in range(options.expnum):
    ...
    for i in range(len(tsize)):
        ...
        # egmgan_res[0, i] = train_evaluate_gmgan_for_hitball(gmgan, trqueries, trvmps, tdata, True, max_epochs=20000, sup_max_epoch=20001)

        print(">>>> train GMGANs")
        egmgan_res[0, i] = train_evaluate_gmgan_for_hitball(gmgan, trqueries, trvmps, tdata, False, max_epochs=20000, sup_max_epoch=20001)
